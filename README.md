...
- [Serverless APIGateway Service Proxy](#serverless-apigateway-service-proxy)
  - [Serverless v4 Compatibility](#serverless-v4-compatibility)
  - [TOC](#toc)
  - [Install](#install)
  ...
  - [How to use](#how-to-use)
    ...
    - [SQS](#sqs)
      ...
      - [Customizing responses](#customizing-responses)
        - [Simplified response template customization](#simplified-response-template-customization)
        - [Full response customization](#full-response-customization)
    - [S3](#s3)
      ...
      - [Allow Binary Type](#allow-binary-type)
    - [SNS](#sns)
      - [Customizing responses](#customizing-responses-2)
        - [Simplified response template customization](#simplified-response-template-customization-1)
        - [Full response customization](#full-response-customization-1)
        - [Content Handling and Pass Through Behaviour customization](#content-handling-and-pass-through-behaviour-customization)
    - [DynamoDB](#dynamodb)
      - [Customizing responses](#customizing-responses-3)
        - [Simplified response template customization](#simplified-response-template-customization-2)
        - [Full response customization](#full-response-customization-2)
  ...
  - [Common API Gateway features](#common-api-gateway-features)
    ...
    - [Customizing request body mapping templates](#customizing-request-body-mapping-templates-1)
      - [Kinesis](#kinesis-1)
      - [SQS](#sqs-1)
      - [SNS](#sns-1)
    - [Custom response body mapping templates](#custom-response-body-mapping-templates)
      - [Kinesis Example](#kinesis-example)
